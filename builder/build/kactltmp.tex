\kactlref{convex-hull-trick.hpp}
\defdescription{$\text{add}(a, b)$ adds a straight line $y = a x + b$.
\texttt{getMaxY(p)} finds the maximum $y$ at $x = p$.
}
\rightcaption{bb0dd6, 72 lines}
\begin{lstlisting}[caption={convex-hull-trick.hpp}, language=C++]
struct Line
{
	LL a, b, xLast;
	Line() {}
